...
void RunningAverageSt::addValue(double value)
{
...
double RunningAverageSt::getAverage()
{
...
double RunningAverageSt::getElement(uint8_t idx)
{
...
void RunningAverageSt::fillValue(double value, uint8_t number)
{
